...
module.exports = {
    ...
    async exec(msg, sock, args) {
        if (args[0]) {
            ...
            let str = '\t'.repeat(13) + "_*Kaguya-bot*_\n\n"
            ...
            await sock.sendMessage(msg.from, {
                image: { url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThpFem2fmaV9Xdy2mCQEyXitsEeyjY9K8AhQ&usqp=CAU"},
                text: str,
                footer: "Kaguya PublicBot • Das",
                templateButtons: [
                    { urlButton: { displayText: "Support Group", url: "https://chat.whatsapp.com/LN4mY3laHz61S1ybxHBeYd" } },
                    { urlButton: { displayText: "Mizuhara", url: "https://github.com/Arus-Bots/Mizuhara" } }
                ]
            }, { quoted: msg })
        }
    }
